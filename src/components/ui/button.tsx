  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-card hover:shadow-elegant",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        spice: "bg-gradient-spice text-white hover:shadow-glow transition-bounce font-semibold",
        cart: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-card hover:shadow-elegant",
        hero: "bg-gradient-primary text-white border-2 border-white/20 hover:border-white/40 shadow-glow hover:shadow-elegant transition-bounce font-semibold",
      },
      size: {
