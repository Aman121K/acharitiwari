...
const BlogPage = () => {
  ...
  const articleCard=(post:typeof blogPosts[number])=><Card key={post.id} className="group product-card overflow-hidden">
    <div className="aspect-[4/3] overflow-hidden bg-[#f4eee3] p-2"><img src={post.image} alt={post.title} className="h-full w-full object-contain" /></div>
